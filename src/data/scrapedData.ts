...
const _STAFF_MEMBERS: StaffMember[] = [
  {
    ...
    image_url: "https://app.ckpcet.ac.in/webroot/files/StaffMasters/photo/1645260034.jpg",
    isTeaching: true
  },
  {
    name: "Dr. Ami T. Choksi",
    designation: "Department In-charge, Computer Engineering",
    qualification: "Ph.D (Computer Engg.), M.E. (Computer Engg.), B.E. (Computer Engg.)",
    experience: "25 years+",
    area_of_interest: "Semantic Web, Sentiment Analysis",
    email: "ami.choksi@ckpcet.ac.in",
    image_url: "https://app.ckpcet.ac.in/webroot/files/StaffMasters/photo/1782980082.jpg",
    isTeaching: true
  },
  {
    name: "Dr. Reena Popawala",
    designation: "Department In-charge, Civil Engineering",
    qualification: "Ph.D, M.E (Civil), B.E (Civil)",
    experience: "26 years+",
    area_of_interest: "Environmental Engineering, Sustainable Water & Waste Management, Construction Management",
    email: "reena.popawala@ckpcet.ac.in",
    image_url: "https://app.ckpcet.ac.in/webroot/files/StaffMasters/photo/1611460160.jpg",
    isTeaching: true
  },
  {
    name: "Dr. Kalpesh D. Maniya",
    designation: "Department In-charge, Mechanical Engineering",
    qualification: "Ph.D, M.E (Mechanical), B.E (Mechanical)",
    experience: "23 years+",
    area_of_interest: "Multi Criteria Decision Making Methods, Machine Design and Manufacturing",
    email: "kalpesh.maniya@ckpcet.ac.in",
    image_url: "https://app.ckpcet.ac.in/webroot/files/StaffMasters/photo/1612334958.jpg",
    isTeaching: true
  }
];
