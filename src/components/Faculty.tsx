...
export default function Faculty() {
  ...
  const leadership = [
    STAFF_MEMBERS[0], // Dr. Chaitanya K. Desai - Principal
    STAFF_MEMBERS[1], // Dr. Marteenkumar H Patel - Assistant Professor
    STAFF_MEMBERS[2], // Mr. Hitesh B Vora - Head of Department (HOD)
    STAFF_MEMBERS[3], // Mr. Gaurang A Joshi - Senior Faculty
  ];
              ...
              <div>
                <div className="relative overflow-hidden rounded-xl aspect-[4/3] sm:aspect-[4/5] mb-3 sm:mb-5 bg-slate-100">
                  <img
                    ...
                    onError={(e) => {
                      (e.target as HTMLImageElement).src = "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&fit=crop&q=80&w=600";
                    }}
                  />
