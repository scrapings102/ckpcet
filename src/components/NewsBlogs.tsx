...
- **Department Allocation:** Computer Engineering, Information Technology, and AIML.
...
- **Outstanding Concept:** Winner certificates went to the computerized grievance-dispatch system mockup for urban municipal wards.
  ...
  },
  {
    ...
    date: "2026-03-28",
    title: "CKPCET Annual Khel Mahotsav & Athletics Championship 2026 Concludes with Triumph",
    ...
    content: `
The **CKPCET Annual Khel Mahotsav 2026** brought together student athletes across Computer Engineering, IT, Civil, Mechanical, Electrical, ECE, and AIML departments in a display of sportsmanship and high energy.

### Championship Highlights
- **Individual Champions:** Outstanding Player trophy awarded to Computer Engineering final-year sprinter Vivek Patel (Gold in 100m, 200m & Long Jump).
- **Overall Department Shield:** Department of Mechanical Engineering clinched the overall team trophy with 14 podium finishes.
- **Women's Powerhouse:** Civil Engineering female athletics contingent dominated relay and table tennis categories.
...
Trustees and faculty directors commended the sports council for immaculate event execution and disciplined play throughout the tournament.
  ...
  },
  {
    ...
    bulletinCategory: "sports",
    date: "2026-03-20",
    title: "GTU Inter-College Cricket Tournament: CKPCET Team Lifts Champions Trophy",
    excerpt: "In a thrilling final match against City Engineering College, CKPCET cricket XI secured victory by 34 runs to claim the South Gujarat university cup.",
    ...
    content: `
Our college cricket squad delivered an all-round masterclass performance in the **GTU Inter-College Cricket Championship Final** held at the Lalbhai Contractor Stadium, Surat.
...
- **University Honors:** The team was felicitated by GTU Sports Board officials with gold medals and a rotating winner trophy.
    `
  },
  {
    id: "sports-3",
    ...
    bulletinCategory: "sports",
    date: "2026-03-12",
    title: "State Level Table Tennis & Badminton Championships: CKPCET Athletes Win Gold",
    excerpt: "CKPCET student players earned top podium finishes in Gujarat State Inter-University Table Tennis and Badminton matches.",
    ...
    content: `
Student athletes representing CKPCET achieved remarkable laurels at the **Gujarat State Collegiate Racket Sports Championship** in Vadodara.

- **Badminton Singles:** Pooja Trivedi (IT 2nd Year) bagged Gold in Women's Singles without dropping a single set.
- **Table Tennis Men's Doubles:** Rohan Patel & Jayesh Shah won Gold in a nail-biting 5-set final against MS University team.
- **National Qualifiers:** Both gold winners have qualified for the All-India Inter-University Games representing GTU.
    `
  },
  {
    id: "sports-4",
...
Candidates must report in proper sports attire with college ID cards. Contact Coach R. S. Jadeja at the Sports Office for registrations.
  ...
  },
  {
    ...
    description: "The official gateway is accepting digital registrations for admissions to Bachelor of Engineering (B.E. / B.Tech) and Master of Engineering (M.E.) programs.",
    content: `
...
export default function NewsBlogs() {
  ...
  return (
    ...
    >
      ...
      <div 
        ref={bgTextRef}
        className="absolute right-0 top-32 text-[14rem] font-bold text-slate-100/10 leading-none select-none pointer-events-none font-display tracking-tighter uppercase hidden xl:block"
      >
        GAZETTE
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl font-bold tracking-tight text-[#3B3131] leading-tight uppercase font-display">
            University <span className="text-[#2563EB]">Gazette Portal</span>
          </h2>
          <p className="font-sans text-slate-500 font-medium text-xs sm:text-sm leading-relaxed max-w-2xl pt-1">
            Stay informed with premium notices, official announcements, schedules, and circulars certified by GTU and AICTE boards.
          </p>
        </div>
            ...
            {[
              ...
              return (
                <button
                  ...
                  className="relative py-2 px-1 text-[11px] sm:text-xs font-sans font-bold uppercase tracking-widest transition-all duration-300 cursor-pointer"
                >
                  ...
                  {filteredItems.map((item, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="absolute left-0 top-0 bottom-0 w-[4px] bg-[#2563EB] scale-y-0 group-hover:scale-y-100 transition-transform origin-center duration-300" />
                        ...
                        <div className="flex items-start sm:items-center gap-4 sm:gap-6 flex-1 min-w-0">
                          ...
                          <div className="space-y-1 flex-1 min-w-0">
                            ...
                            <h4 className="font-sans text-[13px] sm:text-[14.5px] font-bold text-[#3B3131] leading-snug tracking-tight group-hover:text-amber-700 transition-colors uppercase line-clamp-1">
                              {item.title}
                            </h4>
