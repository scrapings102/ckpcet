...
interface BlogPost {
  ...
  title: string;
  subtitle: string;
  category: 'Tech & AI' | 'Business & Innovation' | 'Sports' | 'Campus Life' | 'Research & Innovation';
  author: {
    name: string;
    role: string;
    avatar: string;
...
const BLOG_POSTS: BlogPost[] = [
  {
    id: 'blog-1',
    title: 'The Algorithmic Economy: How AI is Reshaping Modern Engineering & Computing',
    subtitle: 'An analysis by the Engineering & Tech Research Guild',
    ...
    likes: 142,
    excerpt: 'Explore how quantitative modeling, neural network forecasting, and real-time sensor telemetry are reinventing engineering strategy.',
    content: [
      'Engineering architecture is experiencing its most profound transformation since the advent of modern computing. Neural networks and high-frequency algorithms now process millions of sensor parameters per millisecond.',
      'At CKPCET, our students in Computer Engineering and AIML programs combine machine learning with Python algorithms to analyze complex datasets and simulate intelligent systems.',
      'Understanding both technical computing constructs and core engineering principles gives our graduates an unparalleled edge in modern industrial applications.'
    ]
  },
  {
    id: 'blog-sports-1',
    title: 'Khel Mahotsav 2026: CKPCET Athletes Secure Regional Championship Trophies',
    ...
    likes: 128,
    excerpt: 'CKPCET students dominated track and court events at GTU Inter-College Games, claiming 8 gold medals and overall team honors.',
    content: [
      'This year’s annual sports fiesta showcased unparalleled athletic prowess. Our collegiate track team shattered three longstanding GTU meet records in the 400m relay and long jump.',
  ...
  },
  {
    ...
    subtitle: 'Behind the code with Computer Engineering & IT Final Year Teams',
    category: 'Tech & AI',
    author: {
  ...
  },
  {
    ...
    content: [
      ...
      'Sports at CKPCET cultivate teamwork, resilience, and strategic thinking under pressure—traits essential for both corporate boardrooms and cricket pitches.'
    ]
  },
  {
    id: 'blog-3',
    ...
    author: {
      name: 'Ananya Mehta',
      role: 'Engineering Student Council Lead',
  ...
  {
    id: 'blog-4',
    title: 'Life at CKPCET: Cultural Jubilees, Sports Triumphs & Vibrant Campus Guilds',
    ...
    content: [
      'Campus life at CKPCET extends far beyond the lecture hall. From night music galas to competitive cricket leagues and robotics clubs, our student community thrives on creative expression.'
    ]
  }
];
...
const MAGAZINE_ISSUES: MagazineIssue[] = [
  ...
  {
    id: 'mag-2025',
    title: 'THE ENGINEERING & TECH GAZETTE',
    ...
    description: 'A special biannual edition focusing on engineering technology innovations, sustainable systems, and faculty publications.',
    highlights: [
      'Emerging Trends in Artificial Intelligence & Machine Learning',
      'Faculty Research: Sustainable Civil & Mechanical Systems in Gujarat',
...
export default function BlogsAndMagazine() {
  ...
  const categories = ['All', 'Tech & AI', 'Business & Innovation', 'Sports', 'Campus Life', 'Research & Innovation'];
  ...
  return (
    <section id="blogs-magazine" className="py-10 sm:py-24 bg-[#ffffff] text-[#1E293B] font-sans relative overflow-hidden border-t border-slate-100">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-8 sm:mb-14">
          ...
          <h2 className="text-2xl sm:text-4xl lg:text-5xl font-display font-bold text-[#1E293B] tracking-tight leading-tight mb-3 sm:mb-4">
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-3 sm:gap-4 border-b border-slate-100 pb-4 sm:pb-6">
                  ...
                  <button
                    ...
                    className={`px-3.5 py-1.5 rounded-full text-xs font-semibold whitespace-nowrap transition-all shrink-0 cursor-pointer ${
                      selectedCategory === cat
                        ...
                        : 'bg-white border border-slate-200 text-slate-600 hover:border-[#6F4E37]/50 hover:text-[#1E293B]'
                    }`}
                  >
                    {cat}
                  </button>
              ...
              <div className="relative w-full md:w-72">
                <input
                  ...
                  className="w-full bg-white border border-slate-200 rounded-full py-2 pl-9 pr-4 text-xs font-sans text-[#1E293B] placeholder:text-slate-400 outline-none focus:border-[#6F4E37] focus:ring-1 focus:ring-[#6F4E37] transition-all"
                />
                ...
                >
                  <div>
                    <div className="relative h-36 sm:h-48 overflow-hidden bg-slate-100">
                      ...
                      />
                      <span className="absolute top-2.5 left-2.5 sm:top-3 sm:left-3 bg-white/90 backdrop-blur-md text-[#1E293B] font-mono text-[9px] font-bold uppercase tracking-wider px-2 py-0.5 sm:px-2.5 sm:py-1 rounded-md border border-slate-200/60 flex items-center gap-1">
                    ...
                    <div className="p-4 sm:p-6">
                      ...
                      <h4 className="text-sm sm:text-base font-sans font-semibold text-[#1E293B] group-hover:text-[#6F4E37] transition-colors line-clamp-2 leading-snug mb-1.5 sm:mb-2">
                        {post.title}
                      </h4>
              ...
              >
                ...
                <div className="w-full sm:w-48 shrink-0 relative rounded-2xl overflow-hidden shadow-xl border border-slate-200 group cursor-pointer aspect-[3/4] sm:aspect-auto">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/20 to-transparent flex flex-col justify-end p-4 text-white">
                    <span className="text-[10px] font-mono text-[#2563EB] font-bold uppercase mb-1">{issue.edition}</span>
                    <h5 className="font-sans font-semibold text-sm leading-tight text-white">{issue.title}</h5>
                  </div>
                </div>
                ...
                <div className="flex-1 flex flex-col justify-between text-left py-1 min-w-0">
                  <div>
                    ...
                    <h3 className="text-lg sm:text-xl font-sans font-semibold text-[#1E293B] mb-2 truncate">{issue.title}</h3>
                  ...
                  <div className="flex items-center gap-3 mt-auto">
                    <button
                      ...
                      className="flex-1 bg-[#6F4E37] hover:bg-[#1E293B] text-white text-xs font-bold uppercase tracking-wider py-3 px-4 rounded-xl transition-all flex items-center justify-center gap-2 cursor-pointer shadow-sm"
                    >
                      <Eye size={16} />
                      <span>Preview</span>
                    </button>
          ...
          <div data-lenis-prevent="true" className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              ...
              <div className="bg-[#FAF9F5] border-t border-slate-200 px-8 py-5 flex items-center justify-between text-[9.5px] font-mono text-slate-400 uppercase tracking-widest select-none">
                <span>RECORDS ARCHIVES DIVISION // GTU</span>
        ...
        {selectedMagazine && (
          <div data-lenis-prevent="true" className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 bg-black/70 backdrop-blur-md">
            <motion.div
              ...
              className="bg-[#1E293B] text-white rounded-3xl max-w-2xl w-full max-h-[85vh] flex flex-col overflow-hidden relative border border-white/10 shadow-2xl text-left"
            >
              <button
              ...
              <div data-lenis-prevent="true" className="overflow-y-auto flex-1 no-scrollbar p-6 sm:p-8">
                <div className="flex flex-col sm:flex-row gap-6 items-center">
                  ...
                  <div className="flex-1 space-y-3">
                    <span className="font-mono text-xs text-[#2563EB] uppercase font-bold tracking-widest bg-white/10 px-2.5 py-1 rounded-md inline-block">
                      {selectedMagazine.edition}
                    </span>
                    <h3 className="text-2xl font-sans font-semibold text-white">{selectedMagazine.title}</h3>
                    ...
                    <div className="pt-2">
                      <button
                        ...
                        className="w-full bg-[#2563EB] hover:bg-white text-[#1E293B] font-bold text-xs uppercase tracking-widest py-3 px-6 rounded-xl transition-all cursor-pointer shadow-lg"
                      >
